...
final class RecoveryTests: XCTestCase {
    ...
    func testARunIsCountedInEitherDirection() {
        ...
        XCTAssertEqual(
            ElementMatcher.longestRun(of: [13, 12, 11], in: way),
            3,
    ...
    func testLeadingPairsComeFromAlternativesOnly() {
        XCTAssertEqual(
            DefaultRuleBook.leadingPairs(of: "landuse=forest | landuse=wood & foo=bar"),
        ...
        XCTAssertEqual(
            DefaultRuleBook.leadingPairs(of: "highway=* & bicycle=yes"),
            ["highway=*"]
        )
    ...
    func testTheDumpParses() throws {
        ...
        element(
            ...
            0x10804,
            [
                (54.4644210, 19.6596690), (54.4644000, 19.6599050),
