...
final class BuildRecipeNamesTests: RecipeTestCase {
    ...
    func testAFinishedFileNamesTheRegionsThenTheDate() {
        ...
        XCTAssertEqual(
            dated(recipe([region("region-a", "A"), region("region-b", "B")])).fileName(),
    ...
    func testASetNamesTwoRegionsAndCountsTheRest() {
        ...
        let three = dated(
            recipe([
                region("crimean-fed-district", "Crimea"),
    ...
    func testTheAttributionCarriesOpenStreetMapAndKmapBoth() {
        ...
        XCTAssertTrue(
            lines.contains {
                $0.contains("Built by kmap \(Version.number)")
    ...
    func testTheHeaderDescriptionNeverReachesGarminsLimit() {
        ...
        var made = dated(
            recipe([
                region("neighbour-region", "Neighbour Region"),
    ...
    func testTheFamilyNameIsASCIIAndShortWhateverTheRegions() {
        ...
        let many = dated(
            recipe([
                region("saint-helena-ascension-and-tristan-da-cunha", "Saint Helena"),
    ...
    func testAFileNameStopsGrowingWithTheRegionsInIt() {
        ...
        let made = dated(
            recipe([
                region("saint-helena-ascension-and-tristan-da-cunha", "A"),
    ...
    func testTheCutFallsAtAHyphenSoTheNamesStayWhole() {
        ...
        XCTAssertEqual(
            BuildRecipe.fitted(
                "parent-region-child-region-small-region",
                to: 32,
                breakingOn: "-"
            ),
        ...
        XCTAssertEqual(
            BuildRecipe.fitted("short-name", to: 32, breakingOn: "-"),
            "short-name"
        )
    }
}
