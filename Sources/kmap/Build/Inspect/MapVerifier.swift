...
enum MapVerifier {
    ...
    private static func tileFinding(
        _ tiles: Set<String>,
    ...
    private static func routingFinding(
        _ tiles: Set<String>,
        extensions: [String: Set<String>]
    ) -> Finding {
        let routable = tiles.filter {
            extensions[$0]?.contains("NET") == true && extensions[$0]?.contains("NOD") == true
        }
        return Finding(
    ...
    private static func demFinding(
        _ tiles: Set<String>,
        extensions: [String: Set<String>]
    ) -> Finding {
