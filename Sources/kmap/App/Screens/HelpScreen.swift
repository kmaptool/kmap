        ...
        [
            (
                ...
                [
                    .paragraph(
                        t(
                            "Garmin devices — handhelds, watches, bike computers — can"
                    ...
                    .paragraph(
                        t(
                            "kmap turns that free map into a file your Garmin understands."
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "Pick a country, a region or a whole continent, press Build,"
                    ...
                    .paragraph(
                        t(
                            "What goes on it is a set of checkboxes on the build form:"
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "Out of the box kmap draws the familiar looks of"
                    ...
                    .paragraph(
                        t(
                            "On the Styles screen, `i` imports the look from a .img or"
                    ...
                    .paragraph(
                        t(
                            "Styles can be copied, renamed, edited down to single icon"
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "Everything on these screens can be done from a shell, and a few"
                    ...
                    .paragraph(
                        t(
                            "`kmap build <region>` builds a map. `kmap verify <img>` checks"
                    ...
                    .paragraph(
                        t(
                            "A build takes only what it is given: what is not switched on is"
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "A hide removes a rule, not data. kmap finds the rule in the"
                    ...
                    .paragraph(
                        t(
                            "What can be hidden is read from the style kmap is about to"
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "Two roads can meet on screen without sharing a point — to"
                                + " the router that is a dead end. kmap joins forgotten road"
                                + " ends closer than %d m, and only where there is no way round"
                                + " at all.",
                            Int(BuildRecipe.defaultHealRadius)
                        )
                    ),
                    .paragraph(
                        t(
                            "It never joins through a building, a fence or a hedge:"
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "A map is many tiles, and a receiver draws each one clipped to"
                    ...
                    .paragraph(
                        t(
                            "The overlap is how far past its own frame a tile may paint. It"
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "A TYP can carry two drawings of everything: one for daylight and"
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "The stages that hold the most run fewer lanes where there is not"
                    ...
                    .paragraph(
                        t(
                            "`--memory=<GB>` says the machine has less than it does, which is"
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "Contour lines are vector ways generated from elevation data and"
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "A 10 m contour interval is a choice you make and kmap honours"
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "A profile is a named set of build choices — the whole build"
                    ...
                    .paragraph(
                        t(
                            "Changing a field afterwards changes that map only, and says so"
                    ...
                    .paragraph(
                        t(
                            "What a profile does not hold: the region, the family id and the"
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "How a Garmin map looks is decided by its TYP file, which mkgmap"
            ...
            (
                ...
                [
                    ...
                    .paragraph(
                        t(
                            "The language kmap speaks is chosen in Settings and is nothing to"
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "Large regions can be written as several .img files, split along"
            ...
            (
                ...
                [
                    .paragraph(
                        t(
                            "Copy the .img to the Garmin folder on the device or its SD card."
